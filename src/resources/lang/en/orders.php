...
return [
    ...
    'flash-messages' => [
        ...
        'order-expired-and-cloned' => 'Order #:id expired. Fill in the cloned order below.',
    ...
    'tooltips' => [
        ...
        'expire-and-clone-order' => 'Expire & Clone: expire this order at the placed date, then open the create form pre-filled with the same fields (placed at = now)',
    ...
    'modals' => [
        ...
        'expire_and_clone_modal_title'     => 'Expire & Clone Order #:id',
        'expire_and_clone_modal_message'   => 'This will expire Order #:id at its placed date and open the create form pre-filled with the same fields. Proceed?',
    ...
    'buttons' => [
        ...
        'expire-and-clone' => 'Expire & Clone <i class="fa fa-fw fa-clone" aria-hidden="true"></i>',
