<div class="form-group required has-feedback row {{ $errors->has('exchange_rate') ? ' has-error ' : '' }}">
    ...
    <div class="col-12">
        <input type="number" step=".0001" id="exchange_rate" name="exchange_rate" class="form-control" value="{{ $exchange_rate ? @number_format($exchange_rate, 4) : '' }}" placeholder="{{ trans('myfinance2::dividends.forms.item-form.exchange_rate.placeholder') }}" required />
    </div>
