...
@section('template_title'){!! trans('myfinance2::dividends.titles.dashboard') !!}@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                @include('myfinance2::dividends.tables.items-card')
            </div>
        </div>
...
@section('footer_scripts')
    ...
    @include('myfinance2::dividends.scripts.datatables')
