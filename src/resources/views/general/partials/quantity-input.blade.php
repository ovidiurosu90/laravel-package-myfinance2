<div class="mb-3 {{ ($required ?? false) ? 'required ' : '' }}has-feedback row
    {{ $errors->has('quantity') ? 'has-error' : '' }}">
    <label for="quantity-input" class="col-5 control-label">
        {{ trans('myfinance2::general.forms.quantity.label') }}
    </label>
    ...
    <div class="col-12">
        <input type="number" step=".00000001" min="0" id="quantity-input"
            ...
            placeholder="{{ trans('myfinance2::general.forms.quantity.placeholder') }}"
