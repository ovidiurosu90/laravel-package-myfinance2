    ...
    <div class="card">
        <div class="card-header">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="float-right">
                    <a class="btn btn-sm" href="{{ route('myfinance2::dividends.create') }}" target="_blank" data-bs-toggle="tooltip" title="{{ trans('myfinance2::general.tooltips.create-item', ['type' => 'Dividend']) }}">
        ...
        <div class="card-body p-0" style="height: 330px; overflow: auto">
            <div class="list-group-flush flex-fill">
                ...
                @else
                <p class="m-3">{{ trans('myfinance2::home.cards.dividends.no-items') }}</p>
                @endif
            </div>
        </div>
    </div>
