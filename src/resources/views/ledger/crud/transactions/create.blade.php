...
@section('template_title'){{ trans('myfinance2::general.titles.create-item', ['type' => 'Ledger Transaction']) }}@endsection
            ...
            <div class="col-12">
                <div class="card card-post" id="post_card">
                    <div class="card-header">
                        {!! trans('myfinance2::general.titles.create-item', ['type' => 'Ledger Transaction']) !!}
                    ...
                    @include('myfinance2::ledger.forms.create-transaction-form')
                </div>
            </div>
        </div>
    </div>
