<div class="form-group required has-feedback row {{ $errors->has('exchange_rate') ? ' has-error ' : '' }}">
    ...
    <div class="col-3 p-0">
        <input id="toggle-transaction-exchange_rate-input" type="checkbox" data-bs-toggle="toggle" data-ontitle="{{ trans('myfinance2::ledger.tooltips.disable-transaction-exchange_rate-input') }}" data-offtitle="{{ trans('myfinance2::ledger.tooltips.enable-transaction-exchange_rate-input') }}">
    </div>
