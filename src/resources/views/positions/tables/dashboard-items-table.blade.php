<div class="table-responsive">
    <table class="table table-sm table-striped data-table positions-dashboard-items-table">
        <thead class="thead">
            <tr role="row">
                <th>Symbol</th>
                    ...
                    <tr>
                        ...
                        <td class="text-right pr-2">
                            ...
                            @if($item['overall_change2_in_account_currency'])
                                <br />
                                <span data-bs-toggle="tooltip" title="Value without factoring any gains from selling actions!" style="font-style:italic">{!! $item['overall_change2_in_account_currency'] !!}</span>
                            @endif
                        </td>
                        <td class="text-right pr-2">
                            ...
                            @if($item['overall_change2_in_percentage'])
                                <br />
                                <span data-bs-toggle="tooltip" title="Value without factoring any gains from selling actions!" style="font-style:italic">{!! $item['overall_change2_in_percentage'] !!}</span>
                            @endif
                        </td>
                        <td data-bs-toggle="tooltip" title="{!! $item['symbol_name'] !!}"><a href="https://finance.yahoo.com/quote/{{ $item['symbol'] }}" target="_blank">{{ $item['symbol'] }}</a></td>
                    </tr>
        ...
        <tfoot class="tfoot">
            ...
            <tr>
                <td colspan="5"></td>
                <td class="text-right">
                    <span class="font-weight-bold" data-bs-toggle="tooltip" title="Total Cash & Cash Alternatives in Account Currency">Cash: </span>
                    {!! $accountData[$account]['cash']->getFormattedAmount() !!}
                </td>
                <td colspan="7" class="text-left">
                    {!! $accountData[$account]['cash']->getFormattedDetails() !!}
                </td>
            </tr>
        </tfoot>
    </table>
