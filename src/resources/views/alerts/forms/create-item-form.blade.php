<form action="{{ route('myfinance2::price-alerts.store') }}" method="POST"
                ...
                <span data-bs-toggle="tooltip"
                    ...
                    <button type="submit" class="btn btn-success btn-lg w-100"
                        ...
                        <i class="fa fa-save fa-fw">
                            <span class="sr-only">
                                {!! trans('myfinance2::alerts.forms.item-form.buttons.save-item.sr-icon') !!}
                            </span>
                        </i>
                        {!! trans('myfinance2::alerts.forms.item-form.buttons.save-item.name') !!}
                    </button>
                </span>
            </div>
        </div>
