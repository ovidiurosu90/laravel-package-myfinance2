...
@section('template_title'){!! trans('myfinance2::trades.titles.dashboard') !!}@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                @include('myfinance2::trades.tables.items-card')
            </div>
        </div>
...
@section('footer_scripts')
    ...
    @include('myfinance2::trades.scripts.datatables')
