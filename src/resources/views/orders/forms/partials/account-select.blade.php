<div class="mb-3 has-feedback row {{ $errors->has('account_id') ? 'has-error' : '' }}">
    <label for="account-select" class="col-12 control-label">
        {{ trans('myfinance2::orders.forms.item-form.account.label') }}
    </label>
    <div class="col-12">
        <select name="account_id" id="account-select">
            <option value="">
                {{ trans('myfinance2::orders.forms.item-form.account.placeholder') }}
            </option>
